...
<head>
    ...
    <!-- Title -->
    <title>Seven Lab</title>

    <!-- Favicon -->
    <link rel="icon" href="/imgs/sevenpdf.png">

    <!-- Stylesheet -->
    <link rel="stylesheet" href="/css/style.css">
    <link rel="stylesheet" href="/scss/clients.scss">
                        ...
                        <div class="dropdown">
                            <a class="btn pr-0 dropdown-toggle" href="#" role="button" id="langdropdown"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                        src="img/core-img/eng.png" alt=""> English</a>
        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="hamiNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="index.html"><img src="/imgs/core-img/logo.png" alt=""></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <div class="live-chat-btn ml-5 mt-4 mt-lg-0 ml-md-4">
                                <a href="#" class="btn hami-btn live--chat--btn"><i class="fa fa-comments"
                                                                                    aria-hidden="true"></i> Live
                                    Chat</a>
                            </div>
                        </div>
                        <!-- Nav End -->
...
<section class="welcome-area">
    ...
    <div class="welcome-pattern">
        <img src="/imgs/core-img/welcome-pattern.png" alt="">
    </div>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-md-9 col-lg-7">
                            <div class="welcome-text mb-50">
                                <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">The Best <br>
                                    Software Development</h2>
                                <h3 data-animation="fadeInLeftBig" data-delay="400ms" data-duration="1s">Starting at
                                    <span>15,000 L.E</span> 5,000 L.E</h3>
                                <p data-animation="fadeInLeftBig" data-delay="600ms" data-duration="1s">Everything you
                                    will EVER need to Develop and Manage your Ideas!</p>
                                <a href="#" class="btn hami-btn btn-2" data-animation="fadeInLeftBig" data-delay="800ms"
                                   data-duration="1s">Get Start Now!</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="welcome-content h-100">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-md-9 col-lg-7">
                            <div class="welcome-text mb-50">
                                <h2 data-animation="fadeInUpBig" data-delay="200ms" data-duration="1s">The Best <br> Software
                                    Development</h2>
                                <h3 data-animation="fadeInUpBig" data-delay="400ms" data-duration="1s">Starting at
                                    <span>15,000 L.E</span> 5,000 L.E</h3>
                                <p data-animation="fadeInUpBig" data-delay="600ms" data-duration="1s">Everything you
                                    will EVER need to Host and Manage your Ideas!</p>
                                <a href="#" class="btn hami-btn btn-2" data-animation="fadeInUpBig" data-delay="800ms"
                                   data-duration="1s">Get Start Now!</a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Clouds -->
    <div class="clouds">
        <img src="/imgs/core-img/cloud-1.png" alt="" class="cloud-1">
        <img src="/imgs/core-img/cloud-2.png" alt="" class="cloud-2">
        <img src="/imgs/core-img/cloud-3.png" alt="" class="cloud-3">
        <img src="/imgs/core-img/cloud-4.png" alt="" class="cloud-4">
        <img src="/imgs/core-img/cloud-5.png" alt="" class="cloud-5">
    </div>
</section>
<!-- Welcome Area End -->
    ...
    <div class="container-c">
        ...
        <ul class="logogrid">
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Coca-Cola_logo.svg" class="org-color" alt="Coca Cola">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" class="org-color" alt="Google">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/6/69/Airbnb_Logo_B%C3%A9lo.svg" class="org-color" alt="AirBnB">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/2/26/Spotify_logo_with_text.svg" class="org-color" alt="Spotify">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/de/f/f9/Guinness_Logo.svg" class="org-color" alt="Guinness">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/9/92/Audi-Logo_2016.svg" class="org-color" alt="Audi">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_NIKE.svg" class="org-color" alt="Nike">
            </li>
            <li class="logogrid__item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/0/08/Netflix_2015_logo.svg" class="org-color" alt="Netflix">
            </li>
        </ul>
...
<section class="hami-support-area bg-gray">
    ...
    <!-- Support Pattern -->
    <div class="support-pattern" style="background-image: url(/imgs/core-img/support-pattern.png);"></div>
</section>
<!-- Support Area End -->
