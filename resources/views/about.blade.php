...
<section class="hero-wrap hero-wrap-2" style="background-image: url('imgs/bg_1.jpg');"
...
<section class="ftco-section">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-md-5 p-md-5 img img-2" style="background-image: url(imgs/desktop.jpg);">
            </div>
            <div class="col-md-7 wrap-about pb-md-5 ftco-animate">
                ...
                <div class="pl-md-5 ml-md-5 mb-5">
                    <p>Seven Lab is a boutique digital transformation consultancy.
                        Since 2018 we have been helping global companies and established brands reimagine
                        their business by building impactful digital engineering solutions powered by the latest
                        technologies.</p>
        ...
        <div class="row mt-5 pt-4">
            <div class="col-md-4 ftco-animate">
                ...
                <p>Our mission is to help enterprises accelerate adoption of new technologies, untangle complex issues
                    that always emerge during digital evolution, and orchestrate ongoing innovation. Whether it is a
                    consumer-oriented app or a transformative enterprise-class solution</p>
            </div>
            <div class="col-md-4 ftco-animate">
                <h3 class="h4">Vission</h3>
                <p>the company leads the process
                    from ideation and concept to delivery, and provides ongoing support through its IS360 framework.</p>
            </div>
            <div class="col-md-4 ftco-animate">
                <h3 class="h4">Seven L.</h3>
                <p>For over 10 years, Intellectsoft has been helping Fortune 500 companies and established brands build
                    solid software foundations for their businesses.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section testimony-section bg-light">
    <div class="container">
        ...
        <div class="row ftco-animate" style="display: none">
            <div class="col-md-12">
