        ...
        <div class="row justify-content-start mb-5 pb-2">
            ...
            <div class="col-md-8 pl-md-5 heading-section ftco-animate">
                <div class="pl-md-4 border-line">
                    <p>Intellectsoft brings the best from both software worlds to your industry. From one side, you get
                        our 10-year expertise in building wide-ranging custom software. On the other, we have made the
                        most of Mobile Roadie — the leading app platform favored by the most celebrated entertainers,
                        sports teams, and venues that we acquired in 2015. With the upgraded platform and our expertise,
                        we can help you build impactful software solutions for your industry faster than ever
                        before.</p>
                    <p class="category mt-5">
                        ...
                        <span class="mr-2"><a href="#">UI/UX</a></span>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-wrap">
        <div class="row no-gutters">
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="imgs/work-1.jpg" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <span>Interior Design</span>
                        <h3><a href="#">Web apps</a></h3>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="imgs/work-2.jpg" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <span>Interior Design</span>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="project">
                    <img src="imgs/work-3.jpg" class="img-fluid" alt="Colorlib Template">
                    <div class="text">
                        <span>Interior Design</span>
                        <h3>Office Interior Design</h3>
                    </div>
